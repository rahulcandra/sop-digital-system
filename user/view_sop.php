            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="meta-grid">
                        ...
                        <div><p class="meta-label">Terakhir Diupdate</p><p class="meta-value"><?php echo date('d F Y, H:i', strtotime($sop['updated_at'])); ?> WIB</p></div>
                    </div>

                    <?php if ($sop['status'] == 'Revisi' && !empty($sop['catatan_admin'])): ?>
                    <div class="revision-box">
                        <h3 style="color:#ef4444;margin-top:0;font-size:18px;display:flex;align-items:center;gap:10px;"><i class="fas fa-exclamation-circle"></i> Catatan Revisi Admin</h3>
                        <p style="color:var(--tm);font-style:italic;line-height:1.6;margin-bottom:15px;">"<?php echo nl2br(htmlspecialchars($sop['catatan_admin'])); ?>"</p>
                        <a href="edit_sop.php?id=<?php echo $sop['id']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-tools"></i> Klik untuk Memperbaiki Dokumen</a>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="section-box section-violet">
                        ...
                        <a href="../assets/uploads/<?php echo $sop['file_attachment']; ?>" target="_blank" class="btn btn-warning"><i class="fas fa-download"></i> Download File</a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
